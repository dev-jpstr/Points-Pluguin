...
public class AddCommand extends SimpleCommand {
    ...
    public void execute(@NotNull CommandSender sender, @NotNull String[] args) {
        if (args.length != 2) {
            sender.sendMessage(ChatColor.RED + "Utilize /pontos adicionar <usuário> <quantia>.");
            return;
        }
        ...
        sender.sendMessage(ChatColor.YELLOW + "Foram adicionados " + NumberUtil.format(amount) + " pontos para " + offlinePlayer.getName() + ".");
    }
}
